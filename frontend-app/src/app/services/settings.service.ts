...
const DICTIONARY: Record<Language, Record<string, string>> = {
  en: {
    ...
    'dash.last12Hint': 'Click a bar to load that month in the detail above.',
    'dash.scope': 'More Details',
    'dash.recap': 'More Details',
    'dash.yearToDate': 'Year to date',
    'dash.recapMonthNamed': '{month} {year}',
    'dash.recapYearNamed': '{month} {year} to date',
    'dash.monthVsYearsSelected': '{month} {year} vs previous years',
    'dash.monthVsYearsSubSelected': 'Total expenses for {month} {year} in each year',

    'tx.tagline': 'Add and manage your income and expenses.',
    'tx.type': 'Type',
    'tx.category': 'Category',
    'tx.subcategory': 'Sub-category',
    'tx.subcategoryNone': 'None (use category)',
    'tx.subcategoryUnavailable': 'No sub-categories',
    'tx.select': 'Select…',
    ...
    'imp.header': 'Import',
    'imp.tagline': 'Import transactions from a CSV file.',
    'imp.file': 'CSV file',
    'imp.fileHint': 'Select a CSV file with columns: date; category; amount; notes (negative amounts are expenses, positive are income).',
    'imp.fileSelected': 'Selected file',
    'imp.noFile': 'Select a CSV file first.',
    'imp.reading': 'Reading file…',
    'imp.analyze': 'Analyze CSV',
    'imp.analyzing': 'Analyzing data…',
    'imp.readError': 'Could not read the selected file.',
    'imp.recap': 'Import recap',
    'imp.confirmHint': 'Review the summary below, then confirm the import.',
    'imp.toInsert': 'Transactions to insert',
    'imp.invalid': 'Invalid rows',
    'imp.invalidRows': 'Ignored rows',
    'imp.line': 'Line',
    'imp.newCategories': 'New categories to create',
    'imp.noNewCategories': 'No new categories are needed.',
    'imp.createCategories': 'Create the missing categories',
    'imp.createCategoriesHint': 'The missing categories will be created before inserting the transactions.',
    'imp.blocked': 'Enable "Create the missing categories" to continue.',
    'imp.byMonth': 'By month',
    'imp.byYear': 'By year',
    'imp.month': 'Month',
    'imp.year': 'Year',
    'imp.count': 'Transactions',
    'imp.income': 'Income',
    'imp.expenses': 'Expenses',
    'imp.total': 'Balance',
    ...
    'cat.icon': 'Icon',
    'cat.iconPlaceholder': "Emoji or short label, e.g. 🛒",
    'cat.iconPick': 'Pick',
    'cat.color': 'Color',
    'cat.colorHint': 'Hex color shown on the category dot, e.g. #f59e0b',
    'cat.colorPick': 'Pick',
    'cat.clear': 'Clear',
  ...
  it: {
    ...
    'dash.month': 'Mese',
    'dash.year': 'Anno',
    'dash.currentWeek': 'Settimana corrente',
    'dash.currentMonth': 'Mese corrente',
    'dash.currentYear': 'Anno corrente',
    'dash.balance': 'Saldo',
    'dash.income': 'Entrate',
    ...
    'dash.last12Hint': 'Clicca su una barra per caricare quel mese nel dettaglio sopra.',
    'dash.scope': 'Maggiori dettagli',
    'dash.recap': 'Maggiori dettagli',
    'dash.yearToDate': "Dall'inizio dell'anno",
    'dash.recapMonthNamed': '{month} {year}',
    'dash.recapYearNamed': '{month} {year} ad oggi',
    'dash.monthVsYearsSelected': '{month} {year} vs anni precedenti',
    'dash.monthVsYearsSubSelected': 'Spese totali per {month} {year} nel corso degli anni',

    'tx.tagline': 'Aggiungi e gestisci entrate e uscite.',
    'tx.type': 'Tipo',
    'tx.category': 'Categoria',
    'tx.subcategory': 'Sottocategoria',
    'tx.subcategoryNone': 'Nessuna (usa la categoria)',
    'tx.subcategoryUnavailable': 'Nessuna sottocategoria',
    'tx.select': 'Seleziona…',
    ...
    'imp.header': 'Importa',
    'imp.tagline': 'Importa le transazioni da un file CSV.',
    'imp.file': 'File CSV',
    'imp.fileHint': 'Seleziona un file CSV con le colonne: data; categoria; importo; note (gli importi negativi sono uscite, i positivi entrate).',
    'imp.fileSelected': 'File selezionato',
    'imp.noFile': 'Seleziona prima un file CSV.',
    'imp.reading': 'Lettura del file…',
    'imp.analyze': 'Elabora CSV',
    'imp.analyzing': 'Elaborazione dati…',
    'imp.readError': 'Impossibile leggere il file selezionato.',
    'imp.recap': 'Riepilogo importazione',
    'imp.confirmHint': 'Controlla il riepilogo qui sotto e poi conferma l’importazione.',
    'imp.toInsert': 'Transazioni da inserire',
    'imp.invalid': 'Righe non valide',
    'imp.invalidRows': 'Righe ignorate',
    'imp.line': 'Riga',
    'imp.newCategories': 'Nuove categorie da creare',
    'imp.noNewCategories': 'Nessuna nuova categoria necessaria.',
    'imp.createCategories': 'Crea le categorie mancanti',
    'imp.createCategoriesHint': 'Le categorie mancanti verranno create prima di inserire le transazioni.',
    'imp.blocked': 'Attiva "Crea le categorie mancanti" per continuare.',
    'imp.byMonth': 'Per mese',
    'imp.byYear': 'Per anno',
    'imp.month': 'Mese',
    'imp.year': 'Anno',
    'imp.count': 'Transazioni',
    'imp.income': 'Entrate',
    'imp.expenses': 'Uscite',
    'imp.total': 'Saldo',
    ...
    'cat.icon': 'Icona',
    'cat.iconPlaceholder': 'Emoji o etichetta breve, es. 🛒',
    'cat.iconPick': 'Scegli',
    'cat.color': 'Colore',
    'cat.colorHint': 'Colore esadecimale mostrato sul pallino della categoria, es. #f59e0b',
    'cat.colorPick': 'Scegli',
    'cat.clear': 'Azzera',
